...
const ruleProviders = {
  ...
  "github": {
    ...ruleProviderCommon,
    "behavior": "classical",
    "url": "https://fastly.jsdelivr.net/gh/Loyalsoldier/clash-rules@release/github.txt",
...
const rules = [
  ...
  "DOMAIN-SUFFIX,github.io,GitHub", // 已指向GitHub策略组
  ...
  "RULE-SET,github,GitHub", // 增加GitHub规则集关联
  "RULE-SET,proxy,节点选择",
  "RULE-SET,gfw,节点选择",
